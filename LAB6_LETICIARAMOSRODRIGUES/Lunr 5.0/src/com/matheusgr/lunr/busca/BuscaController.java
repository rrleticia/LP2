...
public class BuscaController {
	 ...
	 * parâmetro.
	 * 
	 * @param metadadosBuscados Metadados que devem estar todos presentes nos documentos retornados.
	 * @return                  Array com DocumentoDTO. Não há ordenação definida.
	 */
	public DocumentoDTO[] busca(Map<String, String> metadadosBuscados) {
		this.bv.valida(metadadosBuscados);
		return this.bs.busca(new BuscaAvancada(metadadosBuscados));
	}
