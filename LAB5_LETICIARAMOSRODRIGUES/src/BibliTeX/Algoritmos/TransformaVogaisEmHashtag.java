 ...
 * de modo que as vogais convertem-se em hashtags.
 *
 * @author Leticia Ramos Rodrigues
 */
public class TransformaVogaisEmHashtag implements AlgoritmoTransformacao {
    private final String nomeTransformacao;

    /**
     * Constrói um algoritmo de transformação do tipo TransformaVogaisEmHashtag, ao definir o nome que o identifica.
     */
    public TransformaVogaisEmHashtag(){
        this.nomeTransformacao = "TransformaVogaisEm#";
    }
    ...
    /**
     * Transforma o texto original do usuário, de forma que as vogais (a, e, i, o, u) são substituídas por uma hashtag.
     *
    ...
    public boolean equals(Object o) {
        ...
        TransformaVogaisEmHashtag that = (TransformaVogaisEmHashtag) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(nomeTransformacao);
    }
